...
export default function SignupPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-lg pixel-frame bg-chess-surface/75 p-6">
      ...
      {conflict && (
        <p className="mt-4 rounded-md border border-red-400 bg-red-50 px-3 py-2 text-sm font-medium text-red-800 dark:border-red-600 dark:bg-red-950/50 dark:text-red-100">
          {conflictMsg}
        </p>
      )}
